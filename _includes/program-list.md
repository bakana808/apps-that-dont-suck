...
- {:free}[Rainmeter][rainmeter] add widgets, clocks, and that kind of crap to your screen
...
- {:free}[Speccy][speccy] lists all your hardware specifications for easy bragging

##### Cleaning Tools

- {:rcfr}[CCleaner][ccleaner]
...
- {:rcfr}[Git SCM][git-scm]

- {:free}[GitHub Desktop][github desktop]

##### C++

- {:rcfr}[Microsoft Visual Studio](#) IDE for C++, C#, and VB.net
...
- {:rcfr}[Intellij IDEA](#) IDE for Java and Javascript
